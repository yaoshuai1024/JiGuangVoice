...
- (id)init {
	self = [super init];
	if(self != nil) {
		self.deviceToken = @"3f6042a0 43d8c070 c83b86c5 e53fd135 0901c930 556b2e34 729e3bb1 d59b4f89";
		self.payload = @"{\"aps\":{\"alert\":\"This is some fancy message.\",\"badge\":1}}";
		self.certificate = [[NSBundle mainBundle] pathForResource:@"aps" ofType:@"cer"];
	}
	return self;
}
